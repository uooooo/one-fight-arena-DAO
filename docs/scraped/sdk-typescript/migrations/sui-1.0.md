# Migrate to version 1.0 | Mysten Labs TypeScript SDK Docs

- Source: [https://sdk.mystenlabs.com/typescript/migrations/sui-1.0](https://sdk.mystenlabs.com/typescript/migrations/sui-1.0)
- Retrieved: 2025-11-14 17:44:11 UTC

---

Migrate to version 1.0 | Mysten Labs TypeScript SDK Docs[Mysten Labs SDKs](/)
...
## [Changes to `@mysten/sui`](#changes-to-mystensui)
...
#### [Cloning a Transaction](#cloning-a-transaction)
...
#### [`transaction.blockData` -> `transaction.getData()`](#transactionblockdata---transactiongetdata)
...
#### [`transaction.pure`](#transactionpure)
...
## [new methods on BcsType](#new-methods-on-bcstype)
...
# [@mysten/wallet-standard](#mystenwallet-standard)

### [New wallet-standard features](#new-wallet-standard-features)
...
[Edit on GitHub](https://github.com/MystenLabs/ts-sdks/blob/main/packages/docs/content/typescript/migrations/sui-1.0.mdx)

[Migrate to version 0.38.0

Previous Page](/typescript/migrations/0.38)

### On this page

[Changes to `@mysten/sui`](#changes-to-mystensui)[`@mysten/sui/transactions`](#mystensuitransactions)[Transaction](#transaction)[Building Transactions](#building-transactions)[Cloning a Transaction](#cloning-a-transaction)[`transaction.blockData` -> `transaction.getData()`](#transactionblockdata---transactiongetdata)[`transaction.pure`](#transactionpure)[Commands](#commands)[Transaction types](#transaction-types)[`getPureSerializationType`](#getpureserializationtype)[`@mysten/sui/bcs`](#mystensuibcs)[Bcs Types](#bcs-types)[/utils](#utils)[/multisig](#multisig)[/verify](#verify)[/cryptography](#cryptography)[@mysten/bcs](#mystenbcs)[The Registry](#the-registry)[Size limits](#size-limits)[new methods on BcsType](#new-methods-on-bcstype)[Generics](#generics)[Enums](#enums)[@mysten/kiosk](#mystenkiosk)[@mysten/enoki](#mystenenoki)[dapp-kit](#dapp-kit)[`useSignTransactionBlock`](#usesigntransactionblock)[`useSignAndExecuteTransactionBlock`](#usesignandexecutetransactionblock)[@mysten/zksend](#mystenzksend)[@mysten/wallet-standard](#mystenwallet-standard)[New wallet-standard features](#new-wallet-standard-features)[helpers](#helpers)
