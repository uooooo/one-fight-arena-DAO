...
/// Initialize NO coin using One-Time Witness pattern
...
fun init(otw: NO_COIN, ctx: &mut TxContext) {
    // Create currency using One-Time Witness
    let (initializer, treasury) = coin_registry::new_currency_with_otw<NO_COIN>(
        otw,
        9, // decimals
        string::utf8(b"NO"), // symbol
        string::utf8(b"NO Coin for Prediction Market"), // name
        string::utf8(b"NO coin for prediction market outcomes"), // description
